    ...
    <nav class="nav">
      <div class="pi-pannels f-c ">
        <a class="link-wrapper f-c " href="# ">
          <img class="icons " src="./site/images/behance-logo.svg " alt=" ">
        </a>
        <a class="link-wrapper f-c " href="# ">
          <img class="icons " src="./site/images/instagram-logo.svg" alt=" ">
        </a>
        <a class="link-wrapper f-c " href="# ">
          <svg xmlns="http://www.w3.org/2000/svg" fill="white" width="23" height="23" viewBox="0 0 24 24">
        ...
        <a class="link-wrapper f-c " href="# ">
          <img class="icons " src="./site/images/discord.svg " alt=" ">
        </a>
      </div>
    ...
    <div class="home f-c ">
      <div class="wrapper ">
        <div class="txt-wrapper ">
          ...
          <h2 class="title">
            Web Develop and <br>Graphic Designer
          </h2>
